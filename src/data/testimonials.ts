...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    relationship: "Esposa",
    story: "Eu não sabia que internação involuntária era possível e legal. A PENIEL me explicou tudo, me deu suporte jurídico e psicológico. Meu marido estava em negação total, mas hoje ele me agradece. Diz que salvei a vida dele. A equipe fez a remoção com muito respeito e cuidado.",
    situation: "Alcoolismo grave com agressividade. Recusa total de tratamento. Família com medo. Situação financeira comprometida.",
  ...
  },
  {
    ...
    location: "Manaus, AM",
    relationship: "Tio",
    story: "Meu sobrinho mora em uma cidade pequena do interior do Amazonas. Achávamos impossível conseguir tratamento adequado. A PENIEL organizou toda a logística: passagem, remoção desde a cidade dele, documentação, tudo. Ele está internado em uma excelente clínica em Manaus há 3 meses e a evolução é visível. Sem a PENIEL, não teríamos conseguido.",
    situation: "Dependência de crack em cidade pequena sem recursos. Família sem condições de organizar transferência e internação. Urgência alta.",
